...
export default function Locations() {
  ...
  const buildStaticMapPreview = (lat, lng) => {
    return `https://www.mapquestapi.com/staticmap/v5/map?key=${MAPQUEST_KEY}&center=${lat},${lng}&size=700,400@2x&zoom=14&locations=${lat},${lng}|marker-red`;
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("source_type", image ? "manual" : "generated");
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const res = await api.put(`/api/locations/${editForm.location_id}`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "multipart/form-data",
        },
        ...
        <div className="page-header">
          <div className="page-header-left">
            ...
            <div className="page-title-row">
              <h2>Route Planner & Location Management</h2>
            </div>
